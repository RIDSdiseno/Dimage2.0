...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/archivos/cbct-start-preprocess',[FileController::class, 'startPreprocess'])->name('archivos.cbct-preprocess');
    ...
    Route::middleware('role:1,2')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::post('/administracion/reasignar',        [AdministracionController::class, 'reasignarMasivo'])->name('administracion.reasignar');
