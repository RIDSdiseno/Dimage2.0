                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="border border-blue-100 rounded-xl overflow-hidden">
                                                ...
                                                <div class="p-4 space-y-3">
                                                    ...
                                                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Dientes Ausentes</label><Textarea v-model="respuestas[idx].campo_5" placeholder="Dientes Ausentes" rows="2" class="w-full text-sm" autoResize /></div>
                                                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Observaciones</label><Textarea v-model="respuestas[idx].campo_8" placeholder="Observaciones" rows="2" class="w-full text-sm" autoResize /></div>
                                            ...
                                            <div class="border border-blue-100 rounded-xl overflow-hidden">
                                                ...
                                                <div class="p-4 space-y-3">
                                                    ...
                                                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Dientes Ausentes</label><Textarea v-model="respuestas[idx].campo_9" placeholder="Dientes Ausentes" rows="2" class="w-full text-sm" autoResize /></div>
