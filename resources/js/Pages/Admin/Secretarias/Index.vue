    ...
    <AppLayout title="Secretarías">
        <div class="p-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Secretarías</h1>
                    <p class="text-sm text-gray-400 mt-0.5">{{ total }} secretarias encontradas</p>
                </div>
                <Link :href="route('admin.secretarias.create')">
                    <Button label="Agregar Secretaria" icon="pi pi-plus"
                    ...
                    <tbody>
                            ...
                            <tr v-for="u in users" :key="u.id"
                                ...
                                <td class="px-5 py-3.5 text-right">
                                    <div class="flex items-center justify-end gap-1">
                                        <Link :href="route('admin.secretarias.edit', u.id)">
                        ...
                        <tr v-else>
                            <td colspan="6" class="px-5 py-16 text-center">
                                ...
                                <p class="text-gray-400 font-medium">No se encontraron secretarias.</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
const props = defineProps({
    users: Array, total: Number, currentPage: Number, perPage: Number, filters: Object,
});
...
const applyFilters = (page = 1) => {
    loading.value = true;
    router.get(route('admin.secretarias'), { search: filters.value.search, page }, {
...
const toggle     = (id) => router.post(route('admin.secretarias.toggle', id), {}, { preserveScroll: true });
</script>
